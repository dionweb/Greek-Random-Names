...
function generateName() {
    ...
    if (firstValue == 'male' && secondValue == 'popular'){
        ...
        document.getElementById('result').innerHTML = malePopular[randomnumber] + '<br> is a popular greek male name!';
    }
    else if (firstValue == 'male' && secondValue == 'rare'){
        var randomnumber = Math.floor(Math.random() * (maleRare.length));
        document.getElementById('result').innerHTML = maleRare[randomnumber] + '<br> is a rare greek male name!';    
    }
    else if (firstValue == 'male' && secondValue == 'ancient'){
        var randomnumber = Math.floor(Math.random() * (maleAncient.length));
        document.getElementById('result').innerHTML = maleAncient[randomnumber] + '<br> is an ancient greek male name!';   
    }
        ...
        document.getElementById('result').innerHTML = dontcare[randomnumber] + '<br> is a greek male name!';
    }

    if (firstValue == 'female' && secondValue == 'popular'){
        var randomnumber = Math.floor(Math.random() * (malePopular.length));
        document.getElementById('result').innerHTML = femalePopular[randomnumber] + '<br> is a popular greek female name!';
    }
    else if (firstValue == 'female' && secondValue == 'rare'){
        var randomnumber = Math.floor(Math.random() * (maleRare.length));
        document.getElementById('result').innerHTML = femaleRare[randomnumber] + '<br> is a rare greek female name!';    
    }
    else if (firstValue == 'female' && secondValue == 'ancient'){
        var randomnumber = Math.floor(Math.random() * (maleAncient.length));
        document.getElementById('result').innerHTML = femaleAncient[randomnumber] + '<br> is an ancient greek female name!';   
    }
        ...
        var randomnumber = Math.floor(Math.random() * (dontcare.length));
        document.getElementById('result').innerHTML = dontcare[randomnumber] + '<br> is a greek female name!';
    }
    ...
    if ((firstValue == 'idontcare' && secondValue == 'popular') || (firstValue == 'null' && secondValue == 'popular')){
        ...
        var randomnumber = Math.floor(Math.random() * (dontcare.length));
        document.getElementById('result').innerHTML = dontcare[randomnumber] + '<br> is a popular greek name!';
    }
    else if ((firstValue == 'idontcare' && secondValue == 'rare') || (firstValue == 'null' && secondValue == 'rare')){
        var dontcare = maleRare.concat(femaleRare);
        var randomnumber = Math.floor(Math.random() * (dontcare.length));
        document.getElementById('result').innerHTML = dontcare[randomnumber] + '<br> is a rare greek name!';
    }
        ...
        var randomnumber = Math.floor(Math.random() * (dontcare.length));
        document.getElementById('result').innerHTML = dontcare[randomnumber] + '<br> is an ancient greek name!'; 
    }
        ...
        var randomnumber = Math.floor(Math.random() * (dontcare.length));
        document.getElementById('result').innerHTML = dontcare[randomnumber] + '<br> is a greek name!';
    }

    if (firstValue == 'null' && secondValue == 'null'){
        var dontcare = malePopular.concat(maleRare).concat(maleAncient).concat(femalePopular).concat(femaleRare).concat(femaleAncient);
        var randomnumber = Math.floor(Math.random() * (dontcare.length));
        document.getElementById('result').innerHTML = 'Υou didn\'t choose a category. I print whatever i want.<br>' + dontcare[randomnumber];
    }
